...
export class ProjectsService {
    ...
    private allProjects = [
        ...
        },
        {
            ...
            aboutText: 'Join is a versatile Kanban project management web application designed to help teams stay organized, track tasks in real time, and collaborate more effectively. Built with JavaScript and powered by Firebase Realtime Database, Join offers a dynamic platform where tasks are seamlessly managed and updated across multiple devices. The application allows users to effortlessly manage projects, track progress, and ensure that deadlines are met, all while providing a user-friendly interface. Whether you\'re working solo or as part of a team, Join helps streamline workflows, maintain order, and enhance productivity.',
            keyFeatures: [
